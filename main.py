...
def main():
    ...
    if parseMatrix() == -1 :
        ...
        vertices, matriz = parseMatrix()

    path, coste = Held_Karp(matriz)
    
    path = getPath(path, vertices)
    print("Distancia total: ", coste)
    print("Itinerario: ", path)
